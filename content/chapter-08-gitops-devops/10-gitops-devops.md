...
| `http_head` | HEAD | Health checks, existance checks |
...
| **Server URL** | *(depends on your target API — a test HTTP binary echo service, or the GitHub API base `https://api.github.com`)* |
