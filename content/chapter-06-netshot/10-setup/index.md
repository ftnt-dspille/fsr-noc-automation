...
2. Navigate to the Content Hub
   ![Content Hub in the navigation](images/content_hub.png)
3. Select the **Manage** Tab
4. Click **Upload> Upload Solution Pack**
   ![Upload Solution Pack menu item](images/upload_pack.png)
5. Select the File you downloaded
6. Click **Install**
   
   ![Install button for the Netshot solution pack](images/install_netshot_sp.png?height=500px)
...
1. Search for `Code Snippet`
   ![Searching for the Code Snippet connector](images/search_code_snippet.png?height=400px)
...
3. Click the checkbox's for both **Mark as Default Configuration** and **Allow Universal Imports**
   ![Code Snippet configuration with default and unsafe options checked](images/code_snippet_settings.png)
   {{% notice warning %}}
...
1. Navigate to **System Settings > Roles**
   ![System Settings > Roles](images/system_settings.png)
2. Open **Full App Permissions**
   ![Full App Permissions view](images/img_1.png)
3. Click the highlighted **+** icon shown in the picture below.
   
   ![Highlighted plus icon used to add module permissions](images/img.png?height=500px)

4. Click **Save**
5. After clicking Save, you should see a new section appear on the left navigation pane
   
   ![Netshot section in the left navigation](images/netshot_navigation.png)
   {{% notice tip %}}
...
3. Select the `FortiSOAR-Export-NetshotWorkshop...` file
   ![Selecting the Netshot workshop export file](images/import_workshop_records.png?height=400px)
   {{% notice warning %}}
...
4. Click **Continue** twice
   ![Import wizard options](images/import_wizard_options.png)
5. Click **Run Import**
6. Wait around ~1 minute for the import to finish
   ![Import completed successfully](images/import_success.png?height=150px)
7. Click **Done**