...
![FortiSOAR interface with the main navigation features numbered](images/fortisoar_feature_highlight.png)

| Number | Picture                                                                            | Name                | Description                                                                                             | Common Uses                                                      |
|--------|------------------------------------------------------------------------------------|---------------------|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|
| 1      | ![Navigation expander icon](images/navigation_expander_icon.png)                                  | Navigation Expander | Used to expand the left hand navigation menu.                                                           | Toggle the navigation pane when you need more screen space.      |
| 2      | ![Live sync icon](images/live_sync_icon.png)                                            | Live Sync Icon      | Indicates that the information on the screen is updated in real-time.                                   | Verify you're seeing the latest data during active incidents.    |
| 3      | ![Global search bar](images/search_bar.png)                                                | Search Bar          | Used as a global search for things in FortiSOAR.                                                        | Quickly find specific incidents, alerts, or indicators.          |
| 4      | ![System settings icon](images/system_setting_icon.png)                                       | System Settings     | Used to change the system settings of FortiSOAR.                                                        | Configure user permissions, email settings, and integrations.    |
| 5      | ![Playbook execution history icon](images/execution_history_icon.png)                                    | Execution History   | A log of all the playbooks that have been executed in FortiSOAR.                                        | Troubleshoot automation issues or verify actions were taken.     |
| 6      | ![Notification bell icon](images/notification_bell.png)                                         | Notifications       | Comment mentions or items that require your attention.                                                  | Stay informed about mentions and updates to your assigned items. |
| 7      | ![Pending tasks icon](images/pending_task_icon.png)                                        | Pending Tasks       | A list of tasks or playbook approvals that are assigned to you and require your attention.              | Quickly access your to-do list and required approvals.           |
| 8      | ![User profile icon](images/user_profile_icon.png)                                         | User Profile        | Used to change your user settings and log out of FortiSOAR.                                             | Update your preferences and contact information.                 |
| 9      | {{% expand "Expand Me" %}}![Expanded left navigation menu](images/navigation_menu.png){{% /expand %}} | Navigation Menu     | The left hand navigation menu that contains all the modules and pages you have access to in FortiSOAR.  | Access different modules and functionality of the platform.      |
| 10     | ![Recycle bin icon](images/recycle_bin_icon.png)                                         | Recycle Bin         | A place where deleted records/playbooks are stored. You can restore deleted items from the recycle bin. | Recover accidentally deleted items.                              |
| 11     | ![FortiSOAR version indicator](images/fsr_version_icon.png)                                         | Version             | The version of FortiSOAR you are currently using.                                                       | Verify your version when troubleshooting or updating.            |
